...
import { ArrowDown, Calculator, Sparkles, Sun, ShieldCheck, Zap, ArrowRight } from 'lucide-react';
import { Link } from 'react-router-dom';
import { Button } from '../../../../components/ui/Button';

export const SolarSystemsHeroSection: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'6.6' | '10' | '13.2' | '15+'>('10');
  ...
  const current = capacityDetails[activeTab];
