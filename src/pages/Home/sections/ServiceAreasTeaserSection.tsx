...
export const ServiceAreasTeaserSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 -left-28 w-96 h-96 bg-[#265e11]/8 rounded-full blur-3xl pointer-events-none animate-pulse duration-3000" />
      <div className="absolute bottom-12 -right-28 w-96 h-96 bg-[#ed5001]/8 rounded-full blur-3xl pointer-events-none animate-pulse duration-4000" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-extrabold text-[#18181b] tracking-tight font-serif leading-[1.15]">
              Proudly Powering <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ed5001] via-[#f06e02] to-[#f4a304] inline-block hover:scale-[1.01] transition-transform origin-left">
            ...
            <div className="pt-2">
              <Button
                ...
                variant="primary"
                size="md"
                className="group relative overflow-hidden rounded-xl shadow-lg shadow-[#ed5001]/25 bg-gradient-to-r from-[#ed5001] via-[#f06e02] to-[#f4a304] hover:from-[#c84300] hover:to-[#ed5001] text-white border-0 font-bold px-7 py-3.5 transition-all duration-300 hover:shadow-[#ed5001]/40 hover:-translate-y-0.5"
                icon={
                ...
                return (
                  <Link
                    ...
                    className={`group relative bg-white rounded-lg p-5 border transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-md shadow-slate-900/5 hover:shadow-2xl hover:shadow-orange-500/15 hover:-translate-y-1.5 ${
                      isHovered
                        ? 'border-[#ed5001] ring-2 ring-[#ed5001]/20'
                        : 'border-slate-300/80 hover:border-[#ed5001]/60'
                    } ${
                      isVisible
                  ...
                  >
                    ...
                    <div className="absolute -inset-[1px] bg-gradient-to-r from-[#ed5001]/15 via-[#f4a304]/10 to-[#265e11]/15 rounded-xl opacity-0 group-hover:opacity-100 blur-xs transition-opacity duration-500 -z-10" />
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3">
                        <div className="flex items-center gap-2.5 min-w-0">
                          <div className="w-9 h-9 rounded-lg bg-orange-50 border border-orange-200/80 flex items-center justify-center shrink-0 text-[#ed5001] group-hover:bg-[#ed5001] group-hover:text-white transition-all duration-300 group-hover:scale-105 shadow-xs">
                            <MapPin className="w-4 h-4 group-hover:-translate-y-0.5 group-hover:scale-110 transition-transform duration-300" />
                          </div>
                          <div className="min-w-0">
                            <h3 className="font-bold text-slate-900 group-hover:text-[#ed5001] transition-colors text-base truncate">
                              {area.name}
                            </h3>
                        ...
                        <span className="inline-flex items-center gap-1 text-[11px] font-bold text-[#ed5001] bg-orange-50/90 group-hover:bg-orange-100/80 px-2.5 py-1 rounded-full border border-orange-200/70 shrink-0 transition-colors shadow-2xs">
                          <Sun className="w-3.5 h-3.5 text-[#ed5001] group-hover:rotate-90 group-hover:scale-110 transition-transform duration-500 ease-out" />
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-bold text-[#265e11] bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200/50">
                          {area.averageAnnualSolarSavings}
                        </span>
                      </div>
                      <span className="font-bold text-[#ed5001] group-hover:text-[#c84300] inline-flex items-center gap-1 transition-colors">
              ...
              {regionalCorridors.map((area, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#ed5001] to-[#f4a304] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                    <div>
                      <div className="flex items-center justify-between gap-1 mb-2">
                        <div className="flex items-center gap-1.5 min-w-0">
                          <MapPin className="w-3.5 h-3.5 text-[#ed5001] shrink-0 group-hover:-translate-y-0.5 group-hover:scale-110 transition-transform duration-300" />
                          <h4 className="font-bold text-slate-900 group-hover:text-[#ed5001] transition-colors text-sm truncate">
                            {area.name}
                          </h4>
                        </div>
                        <span className="text-[10px] font-bold text-[#ed5001] bg-orange-50 px-2 py-0.5 rounded-full border border-orange-200/60 shrink-0 inline-flex items-center gap-0.5">
                          <Sun className="w-2.5 h-2.5 text-[#ed5001] group-hover:rotate-90 transition-transform duration-500" />
                    ...
                    <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-[11px]">
                      <span className="font-bold text-[#265e11] truncate">
                        {area.averageAnnualSolarSavings.split(' - ')[0]}/yr
                      </span>
                      <span className="font-bold text-[#ed5001] inline-flex items-center gap-0.5 group-hover:text-[#c84300] transition-colors">
                        <span>View</span>
