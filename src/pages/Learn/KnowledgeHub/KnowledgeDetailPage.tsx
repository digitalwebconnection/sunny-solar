...
export const KnowledgeDetailPage: React.FC = () => {
  ...
  const nextArticle =
    articleIndex < articlesData.length - 1 ? articlesData[articleIndex + 1] : null;
  ...
  // Retrieve rich technical data if available, or fallback gracefully
  const richData = richArticlesMap[article.slug];
