...
export const ProjectsHeroSection: React.FC = () => {
  return (
    <section className="relative pt-28 sm:pt-36 pb-16 sm:pb-10 bg-linear-to-b from-amber-500/10 via-amber-500/5 to-white overflow-hidden ">
      ...
      <div className="absolute top-10 right-10 w-96 h-96 bg-amber-300/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          <div className="p-4  text-center">
            <span className="text-2xl sm:text-3xl font-extrabold text-slate-950 block">4,200+</span>
