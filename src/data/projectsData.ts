...
export const projectsData: Project[] = [
  {
    ...
    selfConsumption: '94%',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Aerial_view_of_Apple_Park_dllu.jpg/1280px-Aerial_view_of_Apple_Park_dllu.jpg',
    gallery: [
      {
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Johnstone_000178_172617_517894_4578_%2836736411886%29.jpg/1280px-Johnstone_000178_172617_517894_4578_%2836736411886%29.jpg',
        caption: 'Concealed conduit routing and laser-aligned Tesla Powerwall 3 battery wall installation',
        tag: 'Battery Storage',
      },
      {
        url: 'https://images.unsplash.com/photo-1545259741-2ea3ebf61fa3?auto=format&fit=crop&w=1200&q=80',
        caption: 'Main switchboard upgraded with lightning surge arresters & sub-100ms backup gateway',
        tag: 'Switchboard & Inverter',
      },
      {
        url: 'https://images.unsplash.com/photo-1624397640148-949b1732bb0a?auto=format&fit=crop&w=1200&q=80',
        caption: 'Clenergy cyclone-rated mounting brackets torqued to coastal engineering specification',
        tag: 'Cyclone Clamping',
      },
      {
        url: 'https://images.unsplash.com/photo-1617269778723-73a40cf299bd?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    selfConsumption: '98%',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Tesla_Solar_Roof-2.jpg/1280px-Tesla_Solar_Roof-2.jpg',
    gallery: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Tesla_Solar_Roof-2.jpg/1280px-Tesla_Solar_Roof-2.jpg',
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Dji_fly_20230602_13826_PM_27_1719032149374_photo_optimized.jpg/1280px-Dji_fly_20230602_13826_PM_27_1719032149374_photo_optimized.jpg',
      ...
      {
        url: 'https://images.unsplash.com/photo-1558441719-8b449c6ff673?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    selfConsumption: '89%',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/PV_and_solar_thermal.jpg/1280px-PV_and_solar_thermal.jpg',
    gallery: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/PV_and_solar_thermal.jpg/1280px-PV_and_solar_thermal.jpg',
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Sunny_Boy_3000.jpg/1280px-Sunny_Boy_3000.jpg',
        caption: 'Compact Sungrow hybrid inverter & modular high-voltage battery tucked under Queenslander sub-floor',
        tag: 'Hybrid Battery',
      },
      {
        url: 'https://images.unsplash.com/photo-1594818379496-da1e345b0ded?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    gallery: [
      {
        url: 'https://images.unsplash.com/photo-1545209568-12d4d97ea63f?auto=format&fit=crop&w=1200&q=80',
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/de/Nellis_AFB_Solar_panels.jpg/1280px-Nellis_AFB_Solar_panels.jpg',
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Solar_trackers.jpg/1280px-Solar_trackers.jpg',
        caption: 'Bifacial dual-glass ground rows designed for maximum morning and late afternoon harvesting',
        tag: 'Bifacial Rows',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Solar_Panels_at_Topaz_Solar_5_%288159036498%29.jpg/1280px-Solar_Panels_at_Topaz_Solar_5_%288159036498%29.jpg',
  ...
  },
  {
    ...
    gallery: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Aerial_view_of_Apple_Park_dllu.jpg/1280px-Aerial_view_of_Apple_Park_dllu.jpg',
      ...
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/4/42/Photovoltaik-NK.jpg',
        caption: 'Commercial string arrays with non-penetrative Klip-Lok clamps preserving roof warranty',
        tag: 'Klip-Lok Clamps',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Pavagada_Solar_Park_2020.jpg',
        caption: 'Heavy-duty Fronius Tauro 50kW commercial string inverter with double-fan active cooling system',
        tag: '50kW Inverter',
      },
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Broken_Hill_solar_plant_aerial.jpg/1280px-Broken_Hill_solar_plant_aerial.jpg',
  ...
  },
  {
    ...
    selfConsumption: '90%',
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/4/42/Photovoltaik-NK.jpg',
    gallery: [
      {
        url: 'https://upload.wikimedia.org/wikipedia/commons/4/42/Photovoltaik-NK.jpg',
